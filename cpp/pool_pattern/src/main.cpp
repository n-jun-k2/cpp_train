...
std::shared_ptr<std::shared_ptr<Point>> build(std::shared_ptr<Pool<Point>>& pointPool) {
...
int main() {
  ...
  std::shared_ptr<Pool<Point, std::vector>> pointpool = Pool<Point, std::vector>::createPool(5);
